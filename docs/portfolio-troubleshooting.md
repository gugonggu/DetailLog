...
이 문서는 Detailog를 MVP 수준에서 실제 배포 가능한 서비스에 가깝게 다듬으면서 발견한 기술적 문제와 개선 내용을 정리한 포트폴리오용 기록입니다.
...
- 포트폴리오 시연 환경에서 네트워크 상태에 따라 화면 완성도가 달라질 수 있습니다.
...
- 포트폴리오 시연용 데이터 기준을 README에 추가했습니다.
